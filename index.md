...
From a software design and engineering perspective, I chose re-design the program following the Model-View-ViewModel design pattern. This separates the different components of the application into the Model for data structures, View for UI components, and ViewModel to handle interactions between the View and Model. This design pattern strongly relies on databinding between the View and ViewModel which allows for updates to the Model without manual declarations. 
...
I have also included a partially completed set of UML diagrams as documentation for the application to showcase my ability to create a well-designed and documented application. One of the skills I learned during my coursework at SNHU is the importance of documentation for large programs. Even though these are incomplete and don't encapsulate the entirety of the application, I feel that they do show my ability to consider the project as a whole. These diagrams include
* [Use Case Diagram](https://github.com/JBlackSNHU/JBlackSNHU.github.io/blob/master/UML%20Use%20Cases.pdf)
* [UML Class Diagram](https://github.com/JBlackSNHU/JBlackSNHU.github.io/blob/master/UML%20Class%20Diagram.pdf)
...
### Data Structures
In the area of Algorithms and Data Structures, I feel that I have a strong general understanding but that I am not an expert. I am more than capable of creating meaningful data structures as in the case of the classes that were used in the application. I am also able to create basic algorithms to accomplish the general functionality that may be required in the application. 

An example of two classes that are used in the application are the [Skill class](https://github.com/JBlackSNHU/JBlackSNHU.github.io/blob/master/app/src/main/java/com/example/riftscompanion/Skill.java) and the [Player Character class](https://github.com/JBlackSNHU/JBlackSNHU.github.io/blob/master/app/src/main/java/com/example/riftscompanion/PlayerCharacter.java). The Skill class is designed to be held in array of skills for the Player Character to access during creation and character management. The Skill class utilizes private variables that are accessed through the "get" methods and incorporates a constructor method when the class is initialized. The Player Character class is similar but also utilizes "set" methods that allow for the ViewModel and databinding functionality to set values for the Player Character object that is in use. 
...
The above method does not support partial matches but could easily be modified to support partial match searching of the database. In future versions of this application, such functionality will be implemented for general search parameters. 
